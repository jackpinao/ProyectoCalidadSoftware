...
import pe.cjbs.wilson.layer.controller.InicioController;
...
public class InicioForm extends JDialog
{
	...
	public InicioForm()
	{
		...
		IconUsuario.setIcon( new ImageIcon( InicioForm.class.getResource( "/pe/cjbs/wilson/layer/view/img/usuario.png" ) ) );
		IconUsuario.setBounds( 234, 44, 28, 28 );
		getContentPane().add( IconUsuario );
		
		JLabel IconClave = new JLabel( "" );
		IconClave.setIcon( new ImageIcon( InicioForm.class.getResource( "/pe/cjbs/wilson/layer/view/img/clave.png" ) ) );
		...
		lblNewLabel.setIcon( new ImageIcon( InicioForm.class.getResource( "/pe/cjbs/wilson/layer/view/img/background.jpg" ) ) );
