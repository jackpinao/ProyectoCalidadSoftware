package pe.cjbs.wilson.layer.view.form;
...
import pe.cjbs.wilson.layer.controller.ArticuloController;
import pe.cjbs.wilson.layer.controller.ClienteController;
import pe.cjbs.wilson.layer.view.util.MessageWin;
...
public class Mantenimiento extends JDialog
{
	...
	public Mantenimiento()
	{
		...
		btnBuscarArt.setIcon( new ImageIcon(Mantenimiento.class.getResource("/pe/cjbs/wilson/layer/view/img/buscar.png")) );
		...
		btnRegistrarArt.setIcon( new ImageIcon(Mantenimiento.class.getResource("/pe/cjbs/wilson/layer/view/img/agregar.png")) );
		...
		btnEditarArt.setIcon( new ImageIcon( Mantenimiento.class.getResource( "/pe/cjbs/wilson/layer/view/img/edit.png" ) ) );
		...
		btnEliminarArt.setIcon( new ImageIcon(Mantenimiento.class.getResource("/pe/cjbs/wilson/layer/view/img/quitar.png")) );
		...
		btnSalirArt.setIcon( new ImageIcon(Mantenimiento.class.getResource("/pe/cjbs/wilson/layer/view/img/cerrar.png")) );
		...
		lblNewLabel.setIcon( new ImageIcon(Mantenimiento.class.getResource("/pe/cjbs/wilson/layer/view/img/fondogris.jpg")) );
		...
		btnBuscarCli.setIcon(new ImageIcon(Mantenimiento.class.getResource("/pe/cjbs/wilson/layer/view/img/buscar.png")));
		...
		btnRegistrarCli.setIcon( new ImageIcon(Mantenimiento.class.getResource("/pe/cjbs/wilson/layer/view/img/agregar.png")) );
		...
		btnEditarCli.setIcon( new ImageIcon( Mantenimiento.class.getResource( "/pe/cjbs/wilson/layer/view/img/edit.png" ) ) );
		...
		btnEliminarCli.setIcon( new ImageIcon(Mantenimiento.class.getResource("/pe/cjbs/wilson/layer/view/img/quitar.png")) );
		...
		btnSalirCli.setIcon( new ImageIcon(Mantenimiento.class.getResource("/pe/cjbs/wilson/layer/view/img/cerrar.png")) );
		...
		lblNewLabel_1.setIcon( new ImageIcon(Mantenimiento.class.getResource("/pe/cjbs/wilson/layer/view/img/fondogris.jpg")) );
