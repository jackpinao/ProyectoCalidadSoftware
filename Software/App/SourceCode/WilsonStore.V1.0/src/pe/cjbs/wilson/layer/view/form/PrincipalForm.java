...
public class PrincipalForm
{
	...
	private void initialize()
	{
		...
		btnProceso.setIcon( new ImageIcon( PrincipalForm.class.getResource( "/pe/cjbs/wilson/layer/view/img/proceso.png" ) ) );
		...
		btnTablas.setIcon( new ImageIcon( PrincipalForm.class.getResource( "/pe/cjbs/wilson/layer/view/img/tablas.png" ) ) );
		...
		btnConsulta.setIcon( new ImageIcon( PrincipalForm.class.getResource( "/pe/cjbs/wilson/layer/view/img/consulta.png" ) ) );
		...
		btnReporte.setIcon( new ImageIcon( PrincipalForm.class.getResource( "/pe/cjbs/wilson/layer/view/img/reporte.png" ) ) );
		...
		btnSalir.setIcon( new ImageIcon(PrincipalForm.class.getResource("/pe/cjbs/wilson/layer/view/img/salir.png")) );
