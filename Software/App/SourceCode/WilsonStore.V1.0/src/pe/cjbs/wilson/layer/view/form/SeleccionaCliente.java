...
public class SeleccionaCliente extends JDialog
{
	...
	public SeleccionaCliente()
	{
		...
		btnBuscar.setIcon(new ImageIcon(SeleccionaCliente.class.getResource("/pe/cjbs/wilson/layer/view/img/buscar.png")));
		...
		btnAceptar.setIcon(new ImageIcon(SeleccionaCliente.class.getResource("/pe/cjbs/wilson/layer/view/img/aceptar.png")));
		...
		btnCancelar.setIcon(new ImageIcon(SeleccionaCliente.class.getResource("/pe/cjbs/wilson/layer/view/img/cancelar.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(SeleccionaCliente.class.getResource("/pe/cjbs/wilson/layer/view/img/fondogris.jpg")));
