...
import pe.cjbs.wilson.layer.controller.ProcesosController;
import pe.cjbs.wilson.layer.view.util.MessageWin;
import pe.cjbs.wilson.layer.view.util.Sesion;
import pe.cjbs.wilson.domain.Detalle;
...
public class Procesos extends JDialog
{
	...
	public Procesos()
	{
		...
		btnLimpiar.setIcon(new ImageIcon(Procesos.class.getResource("/pe/cjbs/wilson/layer/view/img/limpiar.png")));
		...
		btnAgregar.setIcon(new ImageIcon(Procesos.class.getResource("/pe/cjbs/wilson/layer/view/img/agregar.png")));
		...
		btnQuitar.setIcon(new ImageIcon(Procesos.class.getResource("/pe/cjbs/wilson/layer/view/img/quitar.png")));
		...
		btnSalir.setIcon(new ImageIcon(Procesos.class.getResource("/pe/cjbs/wilson/layer/view/img/cerrar.png")));
		...
		btnGrabar.setIcon(new ImageIcon(Procesos.class.getResource("/pe/cjbs/wilson/layer/view/img/grabar.png")));
		...
		btnBuscarCli.setIcon(new ImageIcon(Procesos.class.getResource("/pe/cjbs/wilson/layer/view/img/cliente.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(Procesos.class.getResource("/pe/cjbs/wilson/layer/view/img/fondogris.jpg")));
	...
	public void accionGrabar()
	{
		try
		{
			...
			MessageWin.showInfo( "VENTA REGISTRADA" );
			limpiarTabla();
