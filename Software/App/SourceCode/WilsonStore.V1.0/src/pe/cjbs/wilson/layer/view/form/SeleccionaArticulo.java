...
public class SeleccionaArticulo extends JDialog
{
	...
	public SeleccionaArticulo()
	{
		...
		btnBuscar.setIcon(new ImageIcon(SeleccionaArticulo.class.getResource("/pe/cjbs/wilson/layer/view/img/buscar.png")));
		...
		btnAceptar.setIcon(new ImageIcon(SeleccionaArticulo.class.getResource("/pe/cjbs/wilson/layer/view/img/aceptar.png")));
		...
		btnCancelar.setIcon(new ImageIcon(SeleccionaArticulo.class.getResource("/pe/cjbs/wilson/layer/view/img/cancelar.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(SeleccionaArticulo.class.getResource("/pe/cjbs/wilson/layer/view/img/fondogris.jpg")));
