...
import pe.cjbs.wilson.layer.controller.ConsultaController;
import pe.cjbs.wilson.layer.controller.ExportXLSController;
import pe.cjbs.wilson.layer.view.util.MessageWin;
import pe.cjbs.wilson.layer.controller.ExportCSVController;
...
public class ConsultaVentas extends JDialog
{
	...
	public ConsultaVentas()
	{
		...
		btnBuscar.setIcon(new ImageIcon(ConsultaVentas.class.getResource("/pe/cjbs/wilson/layer/view/img/buscar.png")));
		...
		btnXLS.setIcon(new ImageIcon(ConsultaVentas.class.getResource("/pe/cjbs/wilson/layer/view/img/excel.png")));
		...
		btnCSV.setIcon(new ImageIcon(ConsultaVentas.class.getResource("/pe/cjbs/wilson/layer/view/img/csv.png")));
		...
		btnSalir.setIcon(new ImageIcon(ConsultaVentas.class.getResource("/pe/cjbs/wilson/layer/view/img/cerrar.png")));
		...
		btnFechaI.setIcon(new ImageIcon(ConsultaVentas.class.getResource("/pe/cjbs/wilson/layer/view/img/calend.png")));
		...
		btnFechaF.setIcon(new ImageIcon(ConsultaVentas.class.getResource("/pe/cjbs/wilson/layer/view/img/calend.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(ConsultaVentas.class.getResource("/pe/cjbs/wilson/layer/view/img/fondogris.jpg")));
